function(){##############################################################################################
  ...
  # Individual Random Effect (Intercept)
  alpha_L_Int[1:NNest_PLSel] ~ dmnorm(mu_L_I[1:NNest_PLSel], omega_L_I[1:NNest_PLSel,1:NNest_PLSel])
  omega_L_I[1:NNest_PLSel,1:NNest_PLSel] ~ dwish(R_L_I[,],NNest_PLSel)
  for(i in 1:NNest_PLSel){
    mu_L_I[i] <- 0
    for(j in 1:NNest_PLSel){
  ...
  # Individual Random Effect (Slope)
  alpha_L_Slp[1:NNest_PLSel] ~ dmnorm(mu_L_S[1:NNest_PLSel], omega_L_S[1:NNest_PLSel,1:NNest_PLSel])
  omega_L_S[1:NNest_PLSel,1:NNest_PLSel] ~ dwish(R_L_S[,],NNest_PLSel)
  for(i in 1:NNest_PLSel){
    mu_L_S[i] <- 0
    for(j in 1:NNest_PLSel){
